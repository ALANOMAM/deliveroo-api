...
<body>
    <div class="container">
        <div class="mail-body">
            <h1>Hai ricevuto un nuovo ordine da {{ $lead->customer_name }} {{ $lead->customer_surname }}</h1>

            <p>Ecco i dettagli del nuovo ordine ricevuto:</p>
            ...
            <h3>Da consegnare in {{ $lead->customer_address }}</h3>

            <p>
                E' arrivato il momento di preparare l'ordine!,<br>
                Il team di JustBool
            </p>
        </div>
